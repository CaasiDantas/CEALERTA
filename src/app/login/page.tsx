      ...
      {isMobile && (
        <div style={{ 
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
            ...
            <span style={{ fontWeight: '800', fontSize: '1.2rem', letterSpacing: '-1px' }}>CEALERTA</span>
          </div>
        ...
        <div style={{ 
          ...
          {isMobile && (
            <div style={{ marginBottom: '32px' }}>
              <h2 style={{ fontSize: '1.8rem', fontWeight: '800', marginBottom: '8px', color: '#111827' }}>
                {isRegistering ? 'Crie sua conta' : 'Bem-vindo de volta'}
              </h2>
              <p style={{ color: '#6b7280', fontSize: '14px' }}>
                {isRegistering ? 'Registre-se para começar a colaborar.' : 'Insira seus dados para acessar o painel.'}
              </p>
            </div>
          )}
          ...
          <form onSubmit={handleAuth} style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
            ...
            <div>
              ...
              <div style={{ position: 'relative' }}>
                ...
                <input 
                  ...
                  style={{ 
                    width: '100%', 
                    padding: isMobile ? '12px 12px 12px 40px' : '14px 14px 14px 45px', 
                    borderRadius: '10px', 
                    border: '1px solid #e5e7eb', 
                    outline: 'none', 
                    fontSize: isMobile ? '15px' : '16px',
            ...
            <div>
              ...
              <div style={{ position: 'relative' }}>
                ...
                <input 
                  ...
                  style={{ 
                    width: '100%', 
                    padding: isMobile ? '12px 40px 12px 40px' : '14px 45px 14px 45px', 
                    borderRadius: '10px', 
                    border: '1px solid #e5e7eb', 
                    outline: 'none', 
                    fontSize: isMobile ? '15px' : '16px',
            ...
            >
              ...
              {!loading && (isRegistering ? <UserPlus size={isMobile ? 16 : 18} /> : <ArrowRight size={isMobile ? 16 : 18} />)}
            </button>
          </form>
